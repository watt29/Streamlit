...
if os.path.exists(font_path):
    ...
    plt.rcParams['font.family'] = font_prop.get_name()  # ตั้งค่าฟอนต์ Tahoma ให้ matplotlib ใช้
else:
    st.warning("ฟอนต์ Tahoma ไม่พบในเครื่อง จะใช้ฟอนต์เริ่มต้นแทน")
    plt.rcParams['font.family'] = 'Arial'  # ถ้าไม่พบฟอนต์ Tahoma ให้ใช้ฟอนต์เริ่มต้น
